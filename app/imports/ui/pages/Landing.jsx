        ...
        <div className='digits-landing-background'>
          <Grid container stackable centered columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted>This address book enables any number of users to to login and save their                  contacts. You can only see the contacts you created.</Header>
            </Grid.Column>
